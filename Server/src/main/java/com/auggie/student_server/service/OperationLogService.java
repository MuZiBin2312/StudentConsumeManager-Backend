...
public class OperationLogService {
    ...
    // 添加操作日志
    public void addLog(String module, String action, String operator, String requestId, String status, String host, String errorMessage, String identity) {
        ...
        operationLog.setIdentity(identity);      // 设置操作员身份
